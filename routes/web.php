...
Route::group([
    ...
    */
    ...
    Route::group(['prefix' => 'beneficiaries'], function () {
        ...
        Route::get('/removed', 'BeneficiaryController@deleteIndex')->name('beneficiary.delete.index');
        Route::delete('/{beneficiary}/destroy', 'BeneficiaryController@destroy')->name('beneficiary.destroy'); // delete literal
        Route::delete('/destroy/all', 'BeneficiaryController@destroyAll')->name('beneficiary.destroy.all'); // delete literal em todos os beneficiarios inativos
    });
