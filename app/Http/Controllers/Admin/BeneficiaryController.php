...
class BeneficiaryController extends Controller
{
    ...
    public function deleteIndex (Request $request, PlanStatusService $planStatusService) {
        ...
        return view('pages.beneficiaries.general.indexDelete', compact('beneficiaries'));

    }


    public function destroy ($beneficiary)
    {
        $beneficiary = $this->beneficiaryRepository
            ->findOrFail($beneficiary);

        $beneficiary->delete();

        return redirect()->back()->with('sucesso', 'Beneficiário removido com sucesso do banco de dados!');
    }
    ...
    public function destroyAll ()
    {
        ...
        return redirect()->back()->with('sucesso', 'Todos os beneficiários excluídos foram removidos 
