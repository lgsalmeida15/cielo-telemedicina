                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header card-header-primary">
                            <h4 class="card-title">Beneficiários Removidos do Sistema</h4>
                            <p class="card-category">Número Total de Beneficiários: {{ $beneficiaries->total() }}
                                
                            </p>
                        </div>
                        <div class="card-body">
                            <a href="{{route('beneficiary.general.index')}}" class="btn btn-secondary text-dark">
                                Voltar
                            </a>
                            <form action="{{ route('beneficiary.destroy.all') }}" method="POST" style="display:inline">
                                @csrf
                                @method('DELETE')
                                <button
                                    type="submit"
                                    class="btn btn-danger"
                                    onclick="return confirm('Tem certeza que deseja excluir TODOS os beneficiários permanentemente? Essa ação não poderá ser desfeita!')"
                                >
                                    EXCLUIR TODOS
                                </button>
                            </form>
                                                        ...
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton"> {{-- ADICIONADO: dropdown-menu-right para alinhar à direita --}}
                                                                <button
                                                                    ...
                                                                    data-action="{{ route('beneficiary.destroy', ['beneficiary'=>$beneficiary->id]) }}">
            ...
            <form id="deleteBeneficiaryForm" method="POST">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        Tem certeza de que deseja excluir PERMANENTEMENTE o beneficiário (dependentes e outros dados vinculados a ele)
